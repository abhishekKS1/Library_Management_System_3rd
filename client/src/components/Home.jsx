      ...
      <div className="py-10 relative min-w-[90vw]">
         ...
         <div className="ml-20 px-16 py-28 text-white flex flex-col gap-6">
            ...
            <p className="text-xl font-saira">
               Dive into our extensive collection of literary treasures. From timeless classics to <br />
               contemporary bestsellers, we have something for every reader. Whether you're <br />
               seeking thrilling mysteries, heartwarming romances, or thought-provoking <br />
